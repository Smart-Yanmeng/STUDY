...
def itemData():
    ...
    genre = {"Action": 0, "Adventure": 1, "Animation": 2, "Children's": 3, "Comedy": 4, "Crime": 5, "Documentary": 6,
...
def crossValidation(data, user_data, item_data):
    ...
    for train_indices, test_indices in k_fold:
        ...
        for e in test:
            ...
            if (user_pred_jaccard != 0 and user_pred_jaccard != 5) and (
                    item_pred_jaccard != 0 and item_pred_jaccard != 5):
            ...
            if (user_pred_pearson != 0 and user_pred_pearson != 5) and (
                    item_pred_pearson != 0 and item_pred_pearson != 5):
